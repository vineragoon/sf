...
const COST: { [star: number]: (level: number) => number } = {
  ...
  15: (level) => 100 * Math.round(0.78 * Math.round(10 + (level ** 3 * 16 ** 2.7) / 12000)),
  16: (level) => 100 * Math.round(0.78 * Math.round(10 + (level ** 3 * 17 ** 2.7) / 12000)),
  17: (level) => 100 * Math.round(0.78 * Math.round(10 + (level ** 3 * 18 ** 2.7) / 12000)),
  18: (level) => 100 * Math.round(0.78 * Math.round(10 + (level ** 3 * 19 ** 2.7) / 11000)),
  19: (level) => 100 * Math.round(0.78 * Math.round(10 + (level ** 3 * 20 ** 2.7) / 11000)),
  20: (level) => 100 * Math.round(0.78 * Math.round(10 + (level ** 3 * 21 ** 2.7) / 10000)),
  21: (level) => 100 * Math.round(0.78 * Math.round(10 + (level ** 3 * 22 ** 2.7) / 10000)),
  22: (level) => 100 * Math.round(0.78 * Math.round(10 + (level ** 3 * 23 ** 2.7) / 10000)),
  23: (level) => 100 * Math.round(0.78 * Math.round(10 + (level ** 3 * 24 ** 2.7) / 10000)),
  24: (level) => 100 * Math.round(0.78 * Math.round(10 + (level ** 3 * 25 ** 2.7) / 10000)),
};
